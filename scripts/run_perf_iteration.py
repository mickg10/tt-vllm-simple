...
def main() -> int:
    ...
    ap.add_argument("--artifact-dir", default="/home/ttuser/src_docker/plan/glm47_flash/small_wormhole/artifacts/perf_iterations")
    ap.add_argument("--perf-opt", default="/home/ttuser/src_docker/plan/glm47_flash/small_wormhole/perf-opt.md")
