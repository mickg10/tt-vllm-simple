#!/usr/bin/env bash
# deploy.sh — Deploy or diagnose any TT model on any TT device
#
...
#=============================================================================
MODE="${MODE:-run}"
DEPLOY_DIR="${DEPLOY_DIR:-${HOME}/src_docker/ws/tt_vllm_deploy}"
BRANCH="${BRANCH:-main}"
...
Options:
  --deploy-dir DIR     Workspace directory (default: ~/src_docker/ws/tt_vllm_deploy)
...
#=============================================================================
log "=== TT vLLM Deploy — device: ${DEVICE:-custom}, mode: $MODE ==="
